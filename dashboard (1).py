...
show_home_quality = st.sidebar.checkbox("🏠 Home Quality (H% ≥ 45%, +PPG & Form, GPG ≥ 1.2, GCPG ≤ 1.2)")
show_away_quality = st.sidebar.checkbox("✈️ Away Quality (A% ≥ 45%, +PPG & Form, GPG ≥ 1.2, GCPG ≤ 1.2)")
